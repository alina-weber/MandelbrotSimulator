...
int calculate_mandelbrot_GPU(uint16_t* map, double x, double y, double range, uint16_t max_iter, uint16_t width, uint16_t height)
{
    ...
    std::string source = load_kernel("../src/mandelbrot.cl");
...
int calculate_and_visualize_mandelbrot_GPU(uint16_t* map, double x, double y, double range, uint16_t max_iter, uint16_t width, uint16_t height)
{
